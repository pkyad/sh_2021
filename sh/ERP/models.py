...
class Error(models.Model):
    ...
    stack = models.CharField(max_length = 500 , null = True)


class PythonIDEFile(models.Model):
    created = models.DateTimeField(auto_now_add = True)
    user = models.ForeignKey(User , related_name="pythonFiles" , null = False)
    fileContent = models.TextField( max_length= 20000 , null = True , blank = True)
    name = models.CharField(max_length = 500 , null = False)
    runTimeData = models.TextField(max_length=10000 , null = True , blank = True)
