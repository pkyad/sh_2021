    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('fileContent', models.TextField(blank=True, max_length=20000, null=True)),
                ('name', models.CharField(max_length=500)),
                ('runTimeData', models.TextField(blank=True, max_length=10000, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pythonFiles', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Roles',
            fields=[
                ...
                ('applications', models.ManyToManyField(blank=True, related_name='roleApplications', to='ERP.application')),
            ],
        ),
        migrations.CreateModel(
            name='service',
