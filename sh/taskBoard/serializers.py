...
class taskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = task
        fields = ( 'pk', 'title' , 'description' , 'files', 'followers', 'user' , 'created', 'dueDate', 'to', 'subTasks', 'project', 'personal' , 'completion','conversionFactor')
    ...
    def update(self , instance , validated_data):
        ...
        try:
            ...
            instance.conversionFactor = validated_data['conversionFactor']
        except:
            pass
        instance.save()
        return instance
...
class timelineItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = timelineItem
        fields = ('pk','created' , 'user' , 'category' , 'text' , 'task')
